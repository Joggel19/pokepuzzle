static const struct HealLocation sHealLocations[] =
{
    ...
    [HEAL_LOCATION_POKE_PUZZLE_HUB - 1] = {MAP_GROUP(POKE_PUZZLE_HUB), MAP_NUM(POKE_PUZZLE_HUB), 25, 13},
    [HEAL_LOCATION_WORLD_1_1 - 1] = {MAP_GROUP(WORLD_1_1), MAP_NUM(WORLD_1_1), 10, 8},
    [HEAL_LOCATION_POKE_PUZZLE_EXIT - 1] = {MAP_GROUP(POKE_PUZZLE_EXIT), MAP_NUM(POKE_PUZZLE_EXIT), 2, 7},
    [HEAL_LOCATION_WORLD1_LOBBY - 1] = {MAP_GROUP(WORLD1_LOBBY), MAP_NUM(WORLD1_LOBBY), 4, 6},
    [HEAL_LOCATION_WORLD1_E1 - 1] = {MAP_GROUP(WORLD1_E1), MAP_NUM(WORLD1_E1), 9, 18},
};

...
const u8 gText_ThisIsAPokemon[] = _("This is the Pokémon Mew.{PAUSE 96}\p");
...
const u8 gText_TrainerCardCompletion[] = _("COMPLETION");
...
const u8 gText_Var1sTrainerCard[] = _("{STR_VAR_1}'s LAB ID CARD");
...
const u8 gText_ContinueMenuCompletion[] = _("COMPLETION");
...
const u8 gText_SavingCompletion[] = _("COMPLETION");
